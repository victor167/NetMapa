...
/*
var mainViewCache = myApp.addView('.view-main', {
    domCache: true
});*/
...
/*
myApp.onPageInit('swipe-delete nuevaInspeccion modals media-lists', function(page) {
...
<div style="width: 100px;overflow: auto;line-height: 29px;"><i class="material-icons" style=" float: left; "></i><div style=" float: right; ">Camara</div></div>
